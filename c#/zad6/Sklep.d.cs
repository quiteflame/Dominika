...
namespace Sklep_a
{
    ...
    class Program
    {
            ...
            for (int tura = 0; tura <= d; tura++) {
              ...
              if (tura == 0) {
                ...
                for (int i = 0; i < n; i++) {
                  ...
                  int iloscProduktow = rand.Next(m);
                  Klient klient = new Klient(i, iloscProduktow);
                  kolejka.Enqueue(klient);
                  Console.WriteLine("Klient " + klient.id + " trafia do kolejki: " + indexKolejki + " z ilością produktów: " + iloscProduktow);
                }
                continue;
              }
        ...
        static void Main()
        {
            ...
            Console.WriteLine("Ile max produktów na klienta?");
